...
public class TransmissionManager implements TransmissionService {
    ...
    public UpdatedTransmissionResponse update(UpdateTransmissionRequest updateTransmissionRequest) {
        ...
        Transmission updatedTransmission = transmissionRepository.findById(transmission.getId()).orElse(null);
        if (updatedTransmission == null) {
            return null;
        }

        updatedTransmission = transmissionRepository.save(transmission);
